...
namespace Vcsos.mm
{
	public class vmxor: vmoperator
	{
        ...
        public string Info
        {
            get { return "Exclusiv Oder Operator2 Operator3 to Operator1 - XOR @d255, #d5, #d5 "; }
        }
        public bool ParseAndRun (ParserFactory factory)
		{
			...
			if (param1 == InstructionParam2.Pointer)
				MemoryMap.Write (VM.Instance.CurrentCore.Xor( VM.Instance.CurrentCore.Register.Stack.Pop32 (), VM.Instance.CurrentCore.Register.Stack.Pop32 () ), (uint)param1V);
			else if (param1 == InstructionParam2.Register)
				VM.Instance.CurrentCore.Register.Set (factory.m_pRegisters [param1V].Name, VM.Instance.CurrentCore.Xor( VM.Instance.CurrentCore.Register.Stack.Pop32 (), VM.Instance.CurrentCore.Register.Stack.Pop32 () ));
