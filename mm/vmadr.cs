    ...
    public class vmadr : vmoperator
    {
        ...
        public bool ParseAndRun(ParserFactory factory)
        {
            ...
            if (param1 == InstructionParam2.Pointer)
                MemoryMap.Write(
                    VM.Instance.MasterCore.Akku.Add(VM.Instance.MasterCore.Register.Stack.Pop32(), VM.Instance.MasterCore.Register.Stack.Pop32()), (uint)param1V);
            else if (param1 == InstructionParam2.Register)
                VM.Instance.MasterCore.Register.Set(factory.m_pRegisters[param1V].Name, VM.Instance.MasterCore.Akku.Add(VM.Instance.MasterCore.Register.Stack.Pop32(), VM.Instance.MasterCore.Register.Stack.Pop32()));
