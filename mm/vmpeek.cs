...
namespace Vcsos.mm
{
	public class vmpeek : vmoperator
	{
        ...
        public string Info
        {
            get { return "Lese aktullen Wert auf den Stack  - PEEK @d255"; }
        }
        public bool ParseAndRun (ParserFactory factory)
		{
			...
			if (param1 == InstructionParam2.Value)
				MemoryMap.Write (VM.Instance.MasterCore.Register.Stack.Peek32 (), (uint)param1V);
			else if (param1 == InstructionParam2.Register) {
				VM.Instance.MasterCore.Register.Set (factory.m_pRegisters [param1V].Name, VM.Instance.MasterCore.Register.Stack.Peek32 ());
