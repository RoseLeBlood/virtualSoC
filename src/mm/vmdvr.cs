    ...
    public class vmdvr : vmoperator
    {
        ...
        public bool ParseAndRun(ParserFactory factory)
        {
            ...
            if (param1 == InstructionParam2.Pointer)
                MemoryMap.Write(
                    VM.Instance.CurrentCore.Akku.Div(VM.Instance.CurrentCore.Register.Stack.Pop32(), VM.Instance.CurrentCore.Register.Stack.Pop32()), (uint)param1V);
            else if (param1 == InstructionParam2.Register)
                VM.Instance.CurrentCore.Register.Set(factory.m_pRegisters[param1V].Name, VM.Instance.CurrentCore.Akku.Div(VM.Instance.CurrentCore.Register.Stack.Pop32(), VM.Instance.CurrentCore.Register.Stack.Pop32()));
